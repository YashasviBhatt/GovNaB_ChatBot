...
def chatbot_preprocessing():
    ...
    pairs = [
        ...
        ['what is your name(.*)|who are you(.*)', [' I am GovNarB :)']],
...
root.title('GovNarB - A ChatBot made by Yashasvi Bhatt')                    # giving the title to GUI Window
...
# header
Label(text = 'GovNarB', font = 'lucida 25 bold', bg = '#462666', fg = '#fcf4d9', width = 450, height = 2).pack()
